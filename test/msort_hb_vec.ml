...
(* Parallel merge sort using heartbeat_alloc_free fork2join *)
...
let main =
  ...
  Printf.printf "Starting heartbeat_alloc_free merge sort with num_domains=%d array_size=%d cutoff=%d\n%!" num_domains array_size cutoff;
